...
If your new update is itself a rollout, the split changes. Your rollout percentage receives your update. The update that was rolling out becomes the control update for your rollout, so its share grows to the rest. A rollout at 2% leaves the previous rollout serving 98%.
